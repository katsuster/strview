...
public class UFixed16_16 extends Num {
     ...
     */
    @Override
    public UFixed16_16 clone() throws CloneNotSupportedException {
        UFixed16_16 obj = (UFixed16_16)super.clone();
    ...
    public boolean equals(Object o) {
        if (o instanceof UFixed16_16) {
            return (((UFixed16_16)o).val == val);
        } else {
            return false;
        }
    }
