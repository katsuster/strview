 ...
 * @author katsuhiro
 */
public abstract class AbstractNumOld
     ...
     * @param l 数値の長さ（ビット単位）
     */
    public AbstractNumOld(long p, int l) {
     ...
     * @param obj 数値
     */
    public AbstractNumOld(AbstractNumOld obj) {
    ...
    public Object clone()
        ...
        AbstractNumOld obj = (AbstractNumOld)super.clone();
