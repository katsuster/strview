 ...
 * @author katsuhiro
 */
public class SFixed8_8 extends AbstractNumOld {
    private short val;
    ...
    public SFixed8_8(short v, long p, int l) {
        super(p, l);
        setBitsValue(v);
    }
    ...
    public boolean equals(Object o) {
        if (o instanceof SFixed8_8) {
            return (((SFixed8_8)o).val == val);
        } else {
            return false;
        }
    }
