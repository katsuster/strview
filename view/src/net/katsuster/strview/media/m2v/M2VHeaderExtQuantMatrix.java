...
public class M2VHeaderExtQuantMatrix extends M2VHeaderExt
    ...
    public M2VHeaderExtQuantMatrix clone()
        ...
        obj.intra_quantiser_matrix = intra_quantiser_matrix;
        obj.load_non_intra_quantiser_matrix = load_non_intra_quantiser_matrix.clone();
        obj.non_intra_quantiser_matrix = non_intra_quantiser_matrix;
        obj.load_chroma_intra_quantiser_matrix = load_chroma_intra_quantiser_matrix.clone();
        obj.chroma_intra_quantiser_matrix = chroma_intra_quantiser_matrix;
        obj.load_chroma_non_intra_quantiser_matrix = load_chroma_non_intra_quantiser_matrix.clone();
        obj.chroma_non_intra_quantiser_matrix = chroma_non_intra_quantiser_matrix;
